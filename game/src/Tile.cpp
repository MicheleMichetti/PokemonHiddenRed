...
void Tile::setCollisionDirectionsBitmask(uint8_t collision_bitmask) { this->collision_directions_bitmask_ = collision_bitmask; }
void Tile::setInteractionDirectionsBitmask(uint8_t interaction_bitmask) { this->interaction_directions_bitmask_ = interaction_bitmask; }
uint8_t Tile::getCollisionDirectionsBitmask() { return this->collision_directions_bitmask_; }
uint8_t Tile::getInteractionDirectionsBitmask() { return this->interaction_directions_bitmask_; }
